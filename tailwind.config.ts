  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Premium Campus Navigator Colors
        campus: {
          blue: "#0EA5E9", // Electric Blue
          indigo: "#6366F1", // Indigo
          violet: "#8B5CF6", // Violet
          gradient: "linear-gradient(135deg, #6366F1, #8B5CF6, #0EA5E9)",
          glass: "rgba(15, 23, 42, 0.7)",
          glow: "0 0 20px rgba(14, 165, 233, 0.3)",
          food: "#F97316", // Orange for food
          academic: "#3B82F6", // Blue for academic
          hostel: "#10B981", // Green for hostel
      ...
      animation: {
        ...
        "marker-bounce": "marker-bounce 0.6s ease-out",
